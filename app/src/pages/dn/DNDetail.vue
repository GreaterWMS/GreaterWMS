<template>
  <q-list bordered padding>
    <q-item>
      <q-item-section>
        <q-item-label overline>{{ $t('notice.mobile_dn.notice6') }}</q-item-label>
        <q-item-label caption>{{ $t('notice.mobile_dn.notice7') }}</q-item-label>
      </q-item-section>
    </q-item>
    <q-separator spaced/>
    <template v-for="(item, index) in tablelist" :key="index">
      <q-item>
        ...
        <q-item-section side top>
          <q-item-label caption>{{ $t('notice.mobile_dn.notice9') }}{{ item.goods_cost }}</q-item-label>
           <q-item-label caption>{{ $t('notice.mobile_dn.notice10') }}{{ item.goods_qty }}</q-item-label>
        </q-item-section>
      </q-item>
