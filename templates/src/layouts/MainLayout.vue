<template>
  <q-layout view="hHh LpR fFf" :style="{ height: $q.screen.height, width: $q.screen.width }">
    ...
    <q-drawer v-model="drawerleft" show-if-above :width="200" :breakpoint="500" bordered content-class="bg-grey-3 shadow-24">
      <q-scroll-area class="fit" style="overflow-y: auto">
        <q-list>
          ...
          <q-item
            ...
            :class="{ 'my-menu-link': link === 'downloadcenter' && link !== '' }"
          >
            ...
            <div class="q-pa-md row justify-center">
              ...
              <div style="width: 100%">
                ...
                <div v-for="item in chat_list" :key="item.id">
                  <q-chat-message v-if="item.sender === sender + '-' + openid" :name="sender" :text="[item.detail]" bg-color="light-green-4" name-sanitize sent text-sanitize />
