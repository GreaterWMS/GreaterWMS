          ...
          <q-btn round dense flat color="white" icon="translate" style="margin: 0 10px 0 10px">
            ...
            <q-menu>
              <q-list style="min-width: 100px">
                <q-item clickable v-close-popup v-for="(language, index) in langOptions" :key="index" @click="lang = language.value">
    ...
    <q-drawer
      ...
      <q-scroll-area class="fit" style="overflow-y: hidden">
        <q-list>
          ...
          <q-separator />
          <q-item clickable :active="link === 'capital'" to="/capital" @click="linkChange('capital')" v-ripple exact active-class="my-menu-link">
            <q-item-section avatar>
...
export default {
  meta: {
    ...
    meta: {
      ...
      keywords: { name: 'keywords', content: 'GreaterWMS, Open Source Warehouse Management System, WMS,仓库管理系统' }
    }
  },
  data () {
    return {
