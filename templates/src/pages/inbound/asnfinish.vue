  ...
  data () {
    return {
      ...
      columns: [
        ...
        { name: 'goods_actual_qty', label: 'Goods Actual Qty', field: 'goods_actual_qty', align: 'center' },
        { name: 'goods_shortage_qty', label: 'Goods Shortage Qty', field: 'goods_shortage_qty', align: 'center' },
        { name: 'goods_more_qty', label: 'Goods More Qty', field: 'goods_more_qty', align: 'center' },
        { name: 'goods_damage_qty', label: 'Goods Damage Qty', field: 'goods_damage_qty', align: 'center' },
