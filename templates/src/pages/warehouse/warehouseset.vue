...
export default {
  ...
  data () {
    return {
      ...
      table_list: [],
      columns: [
        { name: 'warehouse_name', required: true, label: 'Warehouse_name', align: 'left', field: 'warehouse_name' },
        { name: 'warehouse_city', label: 'Warehouse_city', field: 'warehouse_city', align: 'center' },
        { name: 'warehouse_address', label: 'Warehouse_address', field: 'warehouse_address', align: 'center' },
        { name: 'warehouse_contact', label: 'Warehouse_contact', field: 'warehouse_contact', align: 'center' },
        { name: 'warehouse_manager', label: 'Warehouse_manager', field: 'warehouse_manager', align: 'center' },
