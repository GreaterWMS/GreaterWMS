             ...
             <template v-if="props.row.id === editid">
               <q-td key="warehouse_name" :props="props">
                 <q-input dense
                          ...
                          autofocus
                          :rules="[ val => val && val.length > 0 || 'Please Enter the Warehouse_name']"
                 />
               </q-td>
             </template>
             ...
             <template v-if="props.row.id === editid">
               <q-td key="warehouse_city" :props="props">
                 <q-input dense
                          ...
                          :rules="[ val => val && val.length > 0 || 'Please Enter the Warehouse_city']"
                 />
               </q-td>
             </template>
             <template v-else-if="props.row.id !== editid">
             ...
             <template v-if="props.row.id === editid">
               <q-td key="warehouse_address" :props="props">
                 <q-input dense
                          ...
                          :rules="[ val => val && val.length > 0 || 'Please Enter the Warehouse_address']"
                 />
               </q-td>
             </template>
             <template v-else-if="props.row.id !== editid">
             ...
             <template v-if="props.row.id === editid">
               <q-td key="warehouse_contact" :props="props">
                 <q-input dense
                          ...
                          :rules="[ val => val && val > 0 || 'Please Enter the Warehouse_contact']"
                 />
               </q-td>
             </template>
             <template v-else-if="props.row.id !== editid">
             ...
             <template v-if="props.row.id === editid">
               <q-td key="warehouse_manager" :props="props">
                 <q-input dense
                          ...
                          :rules="[ val => val && val > 0 || 'Please Enter the Warehouse_manager']"
                 />
               </q-td>
             </template>
             <template v-else-if="props.row.id !== editid">
       ...
       <q-card class="shadow-24">
         ...
         <q-card-section style="max-height: 325px; width: 400px" class="scroll">
           ...
           <q-input dense
                    ...
                    label="Warehouse Manager"
                    :rules="[ val => val && val.length > 0 || 'Please Enter the Warehouse_manager']"
                    @keyup.enter="newDataSubmit()"/>
         </q-card-section>
...
export default {
  ...
  data () {
    return {
      ...
      table_list: [],
      columns: [
        { name: 'warehouse_name', required: true, label: 'Warehouse Name', align: 'left', field: 'warehouse_name' },
        { name: 'warehouse_city', label: 'Warehouse City', field: 'warehouse_city', align: 'center' },
        { name: 'warehouse_address', label: 'Warehouse Address', field: 'warehouse_address', align: 'center' },
        { name: 'warehouse_contact', label: 'Warehouse Contact', field: 'warehouse_contact', align: 'center' },
        { name: 'warehouse_manager', label: 'Warehouse Manager', field: 'warehouse_manager', align: 'center' },
        { name: 'creater', label: 'Creater', field: 'creater', align: 'center' },
        { name: 'create_time', label: 'Create Time', field: 'create_time', align: 'center' },
        { name: 'update_time', label: 'Update Time', field: 'update_time', align: 'center' },
