  ...
  data () {
    return {
      ...
      columns: [
        ...
        { name: 'bin_size_w', label: 'Bin_size_W(Unit:mm)', field: 'bin_size_w', align: 'center' },
        { name: 'bin_size_d', label: 'Bin_size_D(Unit:mm)', field: 'bin_size_d', align: 'center' },
        { name: 'bin_size_h', label: 'Bin_size_H(Unit:mm)', field: 'bin_size_h', align: 'center' },
