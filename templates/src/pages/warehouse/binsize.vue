             ...
             <template v-if="props.row.id === editid">
               <q-td key="bin_size_w" :props="props">
                 <q-input dense
                          ...
                          type="number"
                          label="Bin Size Wide(Unit:mm)"
                          :rules="[ val => val && val > 0 || 'Bin_size width must greater than 0']"
                 />
               </q-td>
             </template>
             <template v-else-if="props.row.id !== editid">
             ...
             <template v-if="props.row.id === editid">
               <q-td key="bin_size_d" :props="props">
                 <q-input dense
                          ...
                          type="number"
                          label="Bin Size Depth(Unit:mm)"
                          :rules="[ val => val && val > 0 || 'Bin_size depth must greater than 0']"
                 />
               </q-td>
             </template>
             <template v-else-if="props.row.id !== editid">
             ...
             <template v-if="props.row.id === editid">
               <q-td key="bin_size_h" :props="props">
                 <q-input dense
                          ...
                          label="Bin Size Height(Unit:mm)"
                          :rules="[ val => val && val > 0 || 'Bin_size height must greater than 0']"
                 />
               </q-td>
             </template>
             <template v-else-if="props.row.id !== editid">
...
export default {
  ...
  data () {
    return {
      ...
      table_list: [],
      columns: [
        { name: 'bin_size', required: true, label: 'Bin_size', align: 'left', field: 'bin_size' },
        { name: 'bin_size_w', label: 'Bin Size Wide(Unit:mm)', field: 'bin_size_w', align: 'center' },
        { name: 'bin_size_d', label: 'Bin Size Depth(Unit:mm)', field: 'bin_size_d', align: 'center' },
        { name: 'bin_size_h', label: 'Bin Size Height(Unit:mm)', field: 'bin_size_h', align: 'center' },
