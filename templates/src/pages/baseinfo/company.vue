             ...
             <template v-if="props.row.id === editid">
               <q-td key="company_name" :props="props">
                 <q-input dense
                          ...
                          label="Company_name"
                          autofocus
                          :rules="[ val => val && val.length > 0 || 'Please Enter the company_name']"
                 />
               </q-td>
             </template>
             ...
             <template v-if="props.row.id === editid">
               <q-td key="company_city" :props="props">
                 <q-input dense
                          ...
                          label="Company_city"
                          :rules="[ val => val && val.length > 0 || 'Please Enter the company_city']"
                 />
               </q-td>
             </template>
             <template v-else-if="props.row.id !== editid">
             ...
             <template v-if="props.row.id === editid">
               <q-td key="company_address" :props="props">
                 <q-input dense
                          ...
                          :rules="[ val => val && val.length > 0 || 'Please Enter the company_address']"
                 />
               </q-td>
             </template>
             <template v-else-if="props.row.id !== editid">
             ...
             <template v-if="props.row.id === editid">
               <q-td key="company_contact" :props="props">
                 <q-input dense
                          ...
                          :rules="[ val => val && val > 0 || 'Please Enter the company_contact']"
                 />
               </q-td>
             </template>
             <template v-else-if="props.row.id !== editid">
...
export default {
  ...
  data () {
    return {
      ...
      table_list: [],
      columns: [
        { name: 'company_name', required: true, label: 'Company_name', align: 'left', field: 'company_name' },
        { name: 'company_city', label: 'Company_city', field: 'company_city', align: 'center' },
        { name: 'company_address', label: 'Company_address', field: 'company_address', align: 'center' },
        { name: 'company_contact', label: 'Company_contact', field: 'company_contact', align: 'center' },
        { name: 'company_manager', label: 'Company_manager', field: 'company_manager', align: 'center' },
