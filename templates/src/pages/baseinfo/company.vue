      ...
      >
         ...
         <template v-slot:body="props">
           <q-tr :props="props">
             ...
             <template v-if="props.row.id === editid">
               <q-td key="company_city" :props="props">
                 <q-input dense
                          outlined
                          square
             ...
             <template v-else-if="props.row.id !== editid">
               <q-td key="company_city" :props="props">
                 {{ props.row.company_city }}
               </q-td>
             </template>
             <template v-if="props.row.id === editid">
               <q-td key="company_address" :props="props">
                 <q-input dense
                          outlined
                          square
             ...
             <template v-else-if="props.row.id !== editid">
               <q-td key="company_address" :props="props">
                 {{ props.row.company_address }}
               </q-td>
             </template>
             <template v-if="props.row.id === editid">
               <q-td key="company_contact" :props="props">
                 <q-input dense
                          outlined
                          square
             ...
             <template v-else-if="props.row.id !== editid">
               <q-td key="company_contact" :props="props">
                 {{ props.row.company_contact }}
               </q-td>
             </template>
             <template v-if="props.row.id === editid">
               <q-td key="company_manager" :props="props">
                 <q-input dense
                          outlined
                          square
                          v-model="editFormData.company_manager"
                          label="Company Manager"
                          :rules="[ val => val && val.length > 0 || 'Please Enter The Company Manager']"
                 />
               </q-td>
             </template>
             <template v-else-if="props.row.id !== editid">
               <q-td key="company_manager" :props="props">
                 {{ props.row.company_manager }}
               </q-td>
             </template>
...
export default {
  ...
  data () {
    return {
      ...
      table_list: [],
      columns: [
        { name: 'company_name', required: true, label: this.$t('baseinfo.view_company.company_name'), align: 'left', field: 'company_name' },
        { name: 'company_city', label: this.$t('baseinfo.view_company.company_city'), field: 'company_city', align: 'center' },
        { name: 'company_address', label: this.$t('baseinfo.view_company.company_address'), field: 'company_address', align: 'center' },
        { name: 'company_contact', label: this.$t('baseinfo.view_company.company_contact'), field: 'company_contact', align: 'center' },
        { name: 'company_manager', label: this.$t('baseinfo.view_company.company_manager'), field: 'company_manager', align: 'center' },
      ...
      deleteForm: false,
      deleteid: 0,
      error1: this.$t('baseinfo.view_company.error1'),
      error2: this.$t('baseinfo.view_company.error2'),
      error3: this.$t('baseinfo.view_company.error3'),
      error4: this.$t('baseinfo.view_company.error4'),
      error5: this.$t('baseinfo.view_company.error5'),
      current: 1,
      max: 0,
      total: 0,
      paginationIpt: 1
  ...
  methods: {
    ...
    newDataSubmit () {
      ...
      _this.table_list.forEach(i => {
        companies.push(i.company_name)
      })
      if (companies.indexOf(_this.newFormData.company_name) === -1 && _this.newFormData.company_name.length !== 0) {
      ...
      } else if (companies.indexOf(_this.newFormData.company_name) !== -1) {
        _this.$q.notify({
          message: _this.$t('notice.baseinfoerror.companyerror'),
          icon: 'close',
          color: 'negative'
        })
      } else if (_this.newFormData.company_name.length === 0) {
        _this.$q.notify({
          message: _this.$t('baseinfo.view_company.error1'),
          icon: 'close',
          color: 'negative'
        })
      }
    ...
    editData (e) {
      ...
      _this.editFormData = {
        ...
        company_contact: e.company_contact,
        company_manager: e.company_manager,
