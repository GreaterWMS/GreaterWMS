  ...
  data () {
    return {
      ...
      columns: [
        ...
        { name: 'goods_weight', label: 'Goods Weight(Unit: KG)', field: 'goods_weight', align: 'center' },
        { name: 'goods_volume', label: 'Goods Volume(Unit: Cubic Metres)', field: 'empty_label', align: 'center' },
