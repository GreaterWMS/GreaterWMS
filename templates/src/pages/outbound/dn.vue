    ...
    <div class="q-pa-md" style="width: 100%; margin-top: -20px">
      ...
      >
         <template v-slot:top>
           <q-btn-group push>
             ...
             <q-btn label="Order Release" icon="img:statics/outbound/orderrelease.png" @click="orderreleaseAllData()">
               <q-tooltip content-class="bg-indigo" :offset="[10, 10]" content-style="font-size: 12px">
                Release All Order
               </q-tooltip>
             </q-btn>
             <q-btn label="Download List" icon="cloud_download" @click="downloadlistData()">
               <q-tooltip content-class="bg-indigo" :offset="[10, 10]" content-style="font-size: 12px">
                Download DN List
               </q-tooltip>
             </q-btn>
             <q-btn label="Download Detail" icon="cloud_download" @click="downloaddetailData()">
               <q-tooltip content-class="bg-indigo" :offset="[10, 10]" content-style="font-size: 12px">
                Download DN Detail
               </q-tooltip>
             </q-btn>
      ...
      <q-dialog v-model="neworderForm">
       <q-card class="shadow-24">
         ...
         <div style="float: right; padding: 15px 15px 15px 0">
           <q-btn color="white" text-color="black" style="margin-right: 25px" @click="neworderDataCancel()">Cancel</q-btn>
      ...
      <q-dialog v-model="orderreleaseForm">
       <q-card class="shadow-24">
         ...
         <div style="float: right; padding: 15px 15px 15px 0">
           <q-btn color="white" text-color="black" style="margin-right: 25px" @click="orderreleaseDataCancel()">Cancel</q-btn>
  ...
  data () {
    return {
      ...
      columns: [
        ...
        { name: 'dn_status', label: 'DN Status', field: 'dn_status', align: 'center' },
