         ...
         <template v-slot:body="props">
           <q-tr :props="props">
             ...
             <q-td key="action" :props="props">
               ...
               <q-btn round flat push color="positive" icon="img:statics/outbound/order.png" @click="neworderData(props.row)">
                 <q-tooltip content-class="bg-indigo" :offset="[10, 10]" content-style="font-size: 12px">
                   {{ $t('confirmorder') }}
                </q-tooltip>
               </q-btn>
               <q-btn round flat push color="positive" icon="img:statics/outbound/orderrelease.png" @click="orderreleaseData(props.row)">
                 <q-tooltip content-class="bg-indigo" :offset="[10, 10]" content-style="font-size: 12px">
                   {{ $t('releaseorder') }}
                </q-tooltip>
               </q-btn>
               <q-btn round flat push color="secondary" icon="print" @click="PrintPickingList(props.row)">
                 <q-tooltip content-class="bg-indigo" :offset="[10, 10]" content-style="font-size: 12px">
                   {{ $t('print') }}
                </q-tooltip>
               </q-btn>
               <q-btn round flat push color="purple" icon="img:statics/outbound/picked.png" @click="pickedData(props.row)">
                 <q-tooltip content-class="bg-indigo" :offset="[10, 10]" content-style="font-size: 12px">
                   {{ $t('confirmpicked') }}
                </q-tooltip>
               </q-btn>
               <q-btn round flat push color="dark" icon="rv_hookup" @click="DispatchDN(props.row)">
                 <q-tooltip content-class="bg-indigo" :offset="[10, 10]" content-style="font-size: 12px">
                  {{ $t('dispatch') }}
                </q-tooltip>
               </q-btn>
               <q-btn round flat push color="info" icon="img:statics/outbound/receiving.png" @click="PODData(props.row)">
                 <q-tooltip content-class="bg-indigo" :offset="[10, 10]" content-style="font-size: 12px">
                   {{ $t('outbound.pod') }}
                </q-tooltip>
               </q-btn>
