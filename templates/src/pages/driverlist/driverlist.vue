       ...
       <q-card class="shadow-24">
         ...
         <q-card-section style="max-height: 325px; width: 400px" class="scroll">
           <q-input dense
                    ...
                    label="Driver_name"
                    autofocus
                    :rules="[ val => val && val.length > 0 || 'Please Enter the driver_Name']"
           ...
           <q-input dense
                    ...
                    label="License_plate"
                    :rules="[ val => val && val.length > 0 || 'Please Enter the license_plate']"
                    @keyup.enter="newDataSubmit()"
...
export default {
  ...
  data () {
    return {
      ...
      table_list: [],
      columns: [
        { name: 'driver_name', required: true, label: 'Driver_name', align: 'left', field: 'driver_name' },
        { name: 'license_plate', label: 'License_plate', field: 'license_plate', align: 'center' },
