...
class CustomerPostSerializer(serializers.ModelSerializer):
    ...
    customer_contact = serializers.IntegerField(read_only=False, required=True, validators=[datasolve.data_validate])
...
class CustomerPartialUpdateSerializer(serializers.ModelSerializer):
    ...
    customer_contact = serializers.IntegerField(read_only=False, required=False, validators=[datasolve.data_validate])
...
class FileRenderSerializer(serializers.ModelSerializer):
    ...
    customer_contact = serializers.IntegerField(read_only=False, required=False)
