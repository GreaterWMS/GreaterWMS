...
class CustomerPostSerializer(serializers.ModelSerializer):
    ...
    customer_level = serializers.IntegerField(read_only=False, required=True, validators=[data_validate])
...
class CustomerPartialUpdateSerializer(serializers.ModelSerializer):
    ...
    customer_level = serializers.IntegerField(read_only=False, required=False, validators=[data_validate])
