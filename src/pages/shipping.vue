    ...
    <div class="q-pa-md" style="width: 100%">
      ...
      >
        ...
        <div class="row no-wrap items-center q-pa-sm q-gutter-xs">
          ...
          <div class="col">
            <div class="q-uploader__title">上传发货记录《文件小于1MB》</div>
    ...
    >
      <div class="row no-wrap q-pa-md">
        <div class="column">
          ...
          <q-btn label="发货数量为单笔订单的发货数量，也可以为当天发货的总数量，只接受整数" size="md" align="left" flat icon="warning"/>
...
export default {
  ...
  data () {
    return {
      ...
      columns: [
        ...
        { name: 'shipping_qty', label: '发货数量', field: 'shipping_qty' },
        { name: 'shipping_time', label: '发货日期', field: 'shipping_time' },
  ...
  methods: {
    getList () {
      ...
      get('shipping/list/', { openid: openid, page: this.current, max_page: 50 }).then(response => {
    ...
    downloadexample () {
      openURL('https://scmapi.56yhz.com/shipping/ex/')
    }
  },
  created () {
    this.uploaded = 'https://scmapi.56yhz.com/shipping/?openid=' + this.$q.localStorage.getItem('openid')
  },
  mounted () {
