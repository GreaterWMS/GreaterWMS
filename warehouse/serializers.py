...
class WarehousePostSerializer(serializers.ModelSerializer):
    ...
    warehouse_contact = serializers.IntegerField(read_only=False, required=True, validators=[datasolve.data_validate])
...
class WarehousePartialUpdateSerializer(serializers.ModelSerializer):
    ...
    warehouse_contact = serializers.IntegerField(read_only=False, required=False, validators=[datasolve.data_validate])
