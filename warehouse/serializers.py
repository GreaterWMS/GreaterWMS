...
class WarehouseGetSerializer(serializers.ModelSerializer):
    ...
    warehouse_contact = serializers.IntegerField(read_only=True, required=False)
...
class WarehousePostSerializer(serializers.ModelSerializer):
    ...
    warehouse_name = serializers.CharField(read_only=False,  required=True, validators=[data_validate])
    warehouse_city = serializers.CharField(read_only=False,  required=True, validators=[data_validate])
    warehouse_address = serializers.CharField(read_only=False, required=True, validators=[data_validate])
    warehouse_contact = serializers.IntegerField(read_only=False, required=True, validators=[data_validate])
    warehouse_manager = serializers.CharField(read_only=False, required=True, validators=[data_validate])
...
class WarehousePartialUpdateSerializer(serializers.ModelSerializer):
    warehouse_name = serializers.CharField(read_only=False, required=False, validators=[data_validate])
    warehouse_city = serializers.CharField(read_only=False, required=False, validators=[data_validate])
    warehouse_address = serializers.CharField(read_only=False, required=False, validators=[data_validate])
    warehouse_contact = serializers.IntegerField(read_only=False, required=False, validators=[data_validate])
    warehouse_manager = serializers.CharField(read_only=False, required=False, validators=[data_validate])
