...
class DriverPostSerializer(serializers.ModelSerializer):
    ...
    contact = serializers.IntegerField(read_only=False, required=True, validators=[data_validate])
...
class DriverPartialUpdateSerializer(serializers.ModelSerializer):
    ...
    contact = serializers.IntegerField(read_only=False, required=False, validators=[data_validate])
