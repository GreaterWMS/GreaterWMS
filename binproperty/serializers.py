...
class BinpropertyPostSerializer(serializers.ModelSerializer):
    openid = serializers.CharField(read_only=False, required=False, validators=[openid_validate])
    bin_property = serializers.CharField(read_only=False,  required=True, validators=[data_validate])
...
class BinpropertyUpdateSerializer(serializers.ModelSerializer):
    bin_property = serializers.CharField(read_only=False, required=True, validators=[data_validate])
    creater = serializers.CharField(read_only=False, required=True, validators=[data_validate])
    class Meta:
        model = ListModel
...
class BinpropertyPartialUpdateSerializer(serializers.ModelSerializer):
    bin_property = serializers.CharField(read_only=False, required=False, validators=[data_validate])
