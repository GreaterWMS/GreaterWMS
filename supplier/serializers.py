...
class SupplierGetSerializer(serializers.ModelSerializer):
    ...
    supplier_contact = serializers.IntegerField(read_only=True, required=False)
...
class SupplierPostSerializer(serializers.ModelSerializer):
    ...
    supplier_name = serializers.CharField(read_only=False,  required=True, validators=[data_validate])
    supplier_city = serializers.CharField(read_only=False,  required=True, validators=[data_validate])
    supplier_address = serializers.CharField(read_only=False, required=True, validators=[data_validate])
    supplier_contact = serializers.IntegerField(read_only=False, required=True, validators=[data_validate])
    supplier_manager = serializers.CharField(read_only=False, required=True, validators=[data_validate])
    supplier_level = serializers.IntegerField(read_only=False, required=True, validators=[data_validate])
...
class SupplierPartialUpdateSerializer(serializers.ModelSerializer):
    supplier_name = serializers.CharField(read_only=False, required=False, validators=[data_validate])
    supplier_city = serializers.CharField(read_only=False, required=False, validators=[data_validate])
    supplier_address = serializers.CharField(read_only=False, required=False, validators=[data_validate])
    supplier_contact = serializers.IntegerField(read_only=False, required=False, validators=[data_validate])
    supplier_manager = serializers.CharField(read_only=False, required=False, validators=[data_validate])
    supplier_level = serializers.IntegerField(read_only=False, required=False, validators=[data_validate])
...
class FileRenderSerializer(serializers.ModelSerializer):
    ...
    supplier_contact = serializers.IntegerField(read_only=False, required=False)
